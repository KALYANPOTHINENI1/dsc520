...
#sink("./assignment_02_PothineniKalyan.txt", append = T)
...
person_df2 <- read.csv('data/tidynomicon/person.csv', stringsAsFactors=F)
str(person_df2)
...
col_nm <- c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout")
