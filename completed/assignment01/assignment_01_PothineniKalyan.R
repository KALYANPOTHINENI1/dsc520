...
##rowname <- c("student01", "student02", "student03")
##colname <- c("assignment01","assignment02")
...
colSums(grades, na.rm=FALSE)

## Total points for each student using `rowSums()`
rowSums(grades, na.rm=FALSE)
